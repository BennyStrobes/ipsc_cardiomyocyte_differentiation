...
preprocess_total_expression_dir=$preprocess_data_dir"processed_projected_gaussian_total_expression/"

#  Directory containing covariate information (covariates, PCs)
covariate_dir=$preprocess_data_dir"projected_gaussian_space_covariates/"
...
visualize_total_expression_dir=$preprocess_data_dir"visualize_projected_gaussian_total_expression/"
