...
output_file <- paste0(visualization_dir, "simulation_precision_recall_curves_", linear_effects_sdev, "_linear_effects_sdev_", maf, "_maf_", num_simulations, "_simulations.pdf")
